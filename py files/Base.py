...
class SashaEncounter:
    ...
    def sashabedroomdialog(self):
        if self.sashatalked == False:
            ...
            input()
            print(""" "{}! Where have you been all this time! I haven't seen you in over a week! I figured you most have went on an unannounced vacation." """.format(player_info.name))
            input()
...
class ToriesCafe:
    ...
    def thecafe(self):
        ...
        if cafedecision in ['order', 'eat', ]:
            ...
            input()
            print("You exchange greetings with Holly and start conversing. There’s a lot of catching up to do, you follow each other on social media but of course that's no replacement for proper conversation.")
            print('"Hey {}, Its been a while hasn\'t it? Last time I saw you was when we went King\'s Point your sophomore year of college with a bunch of other high school friends. And the last I saw you regularly was back before you went off to college in 2014!"'.format(player_info.name))  # Yes, I really did just combine the names of Cedar Point and King's Island to make King's Point
            input()
            print("You fill in some details about what you’ve been up too since that trip. Detailing your current living situation with Sasha and Jacob, as well as talking about your various college antics")
            ...
            input()
            print('"Yeah, I dropped out of college at the end of 2016. Believe it or not it wasn’t because I sucked at it, I just wasn’t enjoying it. I know that’s a pretty shit reason to drop out, but I just couldn’t see myself doing another 2 years there. Nor could I see myself being a marketer for the rest of my life"')
            ...
            input()
            print("You can definitely see yourself agreeing with Holly’s decision, thinking back to all the workplace drama and rejected proposals you’ve dealt with…")
            print("You ask Holly what she’s doing for work since she dropped out of college, she offers a surprising answer.")
            input()
            print('"I draw art for a living now! I’ve always been interested in drawing; I’m sure you remember some of my drawings from back in high school. I never really thought of it as a legitimate career path but I’ve managed to find a niche that pays a decent amount of money through commissions."')
            ...
            input()
            print('"So, what have you been doing since graduating college? I know you finished college with a couple internships under your belt and a great GPA, so that’s had to have gotten you somewhere right?"')
            input()
            print("You explain that you used to work for a local big business, but eventually quit for various reasons, including reasons that Holly has already stated, like project managers ignoring ideas.")
            ...
            input()
            print("'Man, that’s fantastic. Hearing stuff like that almost makes me wish I would have stayed in college. I couldn’t imagine having a savings large enough to live on for 2 years. Let alone being able to amass that much money by only working for a year and half!'")
            print("'Still, like I said, I enjoy my work and I wouldn’t want it any other way. Within reason of course.'")
            input()
            print('"Well {}, it’s been fantastic talking but I’ve got a yoga class coming up in a half hour so I’ve gotta run. Hopefully I’ll see you around."'.format(player_info.name))
            ...
            print("Holly is a vixen, no, not like that. In the literal sense. You’ve known her since high school and while you haven’t really been in contact much since college, you still consider her to be a friend, albeit a distant one.")
            input()
            print("You exchange greetings with Holly and start conversing. There’s a lot of catching up to do, you follow each other on social media but of course that isn’t a replacement for proper conversation.")
            print('"Hey {}! Last time I saw you was when we went to the amusement park your sophomore year of college with a bunch of other high school friends. And the last I saw you regularly was back before you went off to college in 2014!"'.format(player_info.name))
            input()
...
class SycamorePark:
    ...
    def parkpathself(self):
        ...
        input()
        print("Like that time their family took you to the water park. It was fantastic. You’d never been too such a wonderful place. Water rides and pools as far as your small eyes could see.")
